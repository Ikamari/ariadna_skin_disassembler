...
exports.default = (0, _redux.combineReducers)({
    ...
    skinParts: _skinParts2.default,
    processStatus: _processStatus2.default,
...
var _SkinCarousel = __webpack_require__(80);

var _SkinCarousel2 = _interopRequireDefault(_SkinCarousel);

var _SkinPartsCarousel = __webpack_require__(82);

var _SkinPartsCarousel2 = _interopRequireDefault(_SkinPartsCarousel);

var _SkinLoader = __webpack_require__(87);
...
var _ImageCarousel = __webpack_require__(79);
...
var updateSkins = exports.updateSkins = function updateSkins(skins) {
    return {
        type: "UPDATE_SKINS",
        payload: skins
    };
...
var _skinParts = __webpack_require__(83);
...
var updateSkinParts = exports.updateSkinParts = function updateSkinParts(parts) {
    return {
        type: "UPDATE_PARTS",
        payload: parts
    };
...
var skins = function skins() {
    ...
    switch (action.type) {
        ...
        case "UPDATE_SKINS":
            return _extends({}, state, { skins: action.payload });
        default:
            return state;
    }
};
...
var skinParts = function skinParts() {
    ...
    switch (action.type) {
        case "UPDATE_PARTS":
            return _extends({}, state, { skinsAreLoading: action.payload });
        default:
            return state;
    }
};
...
var processStatus = function processStatus() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
    var action = arguments[1];
...
var _ImageLoader = __webpack_require__(88);
...
var SkinLoader = function (_Component) {
    ...
    function SkinLoader() {
        _classCallCheck(this, SkinLoader);

        return _possibleConstructorReturn(this, (SkinLoader.__proto__ || Object.getPrototypeOf(SkinLoader)).apply(this, arguments));
    }
...
var FileLoader = function (_Component) {
    _inherits(FileLoader, _Component);

    function FileLoader() {
        _classCallCheck(this, FileLoader);

        return _possibleConstructorReturn(this, (FileLoader.__proto__ || Object.getPrototypeOf(FileLoader)).apply(this, arguments));
    }
    ...
    _createClass(FileLoader, [{
        ...
        value: function checkFileExtension(file, requiredExtension) {
...
FileLoader.propTypes = {
    ...
    returnPath: _propTypes2.default.func.isRequired
};
